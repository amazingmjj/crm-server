...
insert into t_menu(id, name, page_url, parent_id, create_at, update_at, fact_order) values(48, '新客户业务明细表', '/salesManage/reports/newCustomer', 5, sysdate, sysdate, 9);
...
insert into t_menu(id, name, page_url, parent_id, create_at, update_at, fact_order) values(56, '销售绩效新增客户明细表', '/salesManage/reports/newSalePerformance', 5, sysdate, sysdate, 16);
commit ;
